...
func getSystemAccessToken() (string, error) {
	form := "grant_type=password" +
		"&client_id=qap-front" +
		"&client_secret=tIk6IvluTeOS2o23C4nffL48j2fyF50H" +
		"&username=admin@konneqt.io" +
		"&password=LZNK1kguf_KI"
	...
	if resp.StatusCode != http.StatusOK {
		...
		return "", fmt.Errorf("❌ failed to fetch system token: %v - %s", resp.StatusCode, string(body))
	}
